...
public class ListaView extends VerticalLayout {
    ...
    @Autowired
    public ListaView(ListaService listaService, SessionStorage sessionStorage) {
        ...
        editButton.addClickListener(e -> {
            ...
            if (selectedLista != null) {
                sessionStorage.setSelectedListaId(selectedLista.getId().toString());
                getUI().ifPresent(ui -> ui.navigate("editar-lista"));
            } else {
