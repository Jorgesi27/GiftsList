...
import com.example.application.presentacion.ListaView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("Gifts List IW");
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(ListaView.class)) {
            nav.addItem(new SideNavItem("Listas de Regalos", ListaView.class, LineAwesomeIcon.BOOK_DEAD_SOLID.create()));
        }
